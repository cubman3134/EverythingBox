...
// Both readers validate the id against ^[A-Za-z0-9_-]{1,32}$ and return nullopt otherwise: the id
// comes from untrusted pkg/SFO bytes and every consumer pastes it into a filesystem path.
