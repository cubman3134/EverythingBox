...
int main(int argc, char** argv)
{
    ...
    const QString path = QDir::tempPath() + QStringLiteral("/everythingbox_probe.pdf");

    {
        ...
        p.drawText(QRect(200, 200, 4000, 1000), Qt::AlignLeft, QStringLiteral("EverythingBox PDF page 1"));
        w.newPage();
        p.drawText(QRect(200, 200, 4000, 1000), Qt::AlignLeft, QStringLiteral("EverythingBox PDF page 2"));
        p.end();
    }
