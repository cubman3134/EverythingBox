...
| **Linux** (x86_64) | [**EverythingBox-linux-x86_64.AppImage**](https://github.com/cubman3134/EverythingBox/releases/latest/download/EverythingBox-linux-x86_64.AppImage) | `chmod +x` the file and run it. Settings, saves and add-ons are kept in `~/.local/share/EverythingBox` (or `$XDG_DATA_HOME/EverythingBox`) — the AppImage itself is read-only. |
