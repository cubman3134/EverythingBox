...
- Gating: created only when `UiTestServer::wanted()`-equivalent debug conditions hold (same gate: `EB_UITEST` env / Settings ▸ Debug toggle) — zero cost otherwise.
